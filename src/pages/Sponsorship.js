...
<section className="sponsorship-hero-section">
  ...
  {previousPartners.map((partner, index) => {
    ...
    return (
      <div
        key={index}
        style={{display: isBlank && isMobile && "none", minHeight: isBlank && 0,minWidth: isBlank && 0, height: isBlank && 0, boxShadow: isBlank && 'none', padding: isBlank && 0  }}
      ...
      >
        <a
          ...
          href={partner.url}
          target="_blank"
          style={{display: isBlank && isMobile && "none", minHeight: isBlank && 0, minWidth: isBlank && 0, height: isBlank && 0  }}
