export const pressArray = [
  ...
  {
    title:
      "أسبوع الرياض للأزياء يعود بنسخته الثانية مع برنامج موسّع: 5 أيام للاحتفاء بالتميّز والابتكار والتفرّد",
  ...
  {
    title:
      "أسبوع الموضة في الرياض يعود بنسخته الثانية للاحتفال بابتكار الأزياء والتميز العالمي",
...
Hosted by the Saudi Fashion Commission, yet another level of unrivalled creative expression in the fashion space is set to be unveiled next season.`,
  ...
  },
  {
    ...
    title_ar: "أسبوع الرياض للموضة: الجدول الزمني والتواريخ وكيفية الحضور والمزيد",
    description:
      "Bazaar Arabia's guide to the inaugural four-day event, taking place next week in KSA",
    description_ar: "دليل بازار العربية للحدث الافتتاحي الممتد لأربعة أيام، المقرر إقامته الأسبوع القادم في السعودية",
    button: "Read Full Article",
  ...
  },
  {
    ...
    title_ar: "السعودية تطلق أسبوع موضة في الرياض للاستفادة من الفرص",
    description:
    ...
    description_ar: "باريس: أعلنت هيئة الأزياء السعودية أن السعودية ستستضيف أسبوع موضة رسمي من 20-23 أكتوبر في حدث في فندق أفرو في باريس يوم الاثنين.",
    button: "Read Full Article",
  ...
  },
  {
    ...
    title_ar: "30 علامة سعودية ستعرض خلال أول أسبوع موضة في الرياض",
    description:
      "RIYADH: Thirty Saudi brands will take to the runway at the inaugural Riyadh Fashion Week next month.",
    description_ar: "الرياض: ثلاثون علامة سعودية ستحتفي على منصة العرض في أول أسبوع موضة في الرياض الشهر القادم.",
    button: "Read Full Article",
  ...
  },
  {
    ...
    title_ar: "أسبوع الرياض للموضة يكشف عن جدول موسمه الافتتاحي في أكتوبر",
    description:
    ...
    description_ar: "كشف أسبوع الرياض للموضة عن الجدول الرسمي لموسمه الافتتاحي في أواخر أكتوبر مع أربعة أيام من العروض، تتضمن عروض منصة لـ أكثر من 30 مصمماً.",
    button: "Read Full Article",
  ...
  },
  {
    ...
    title_ar: "السعودية تستضيف أول أسبوع موضة يسلط الضوء على العلامات المحلية",
    description:
    ...
    description_ar: "في ما سيكون الأول للبلاد، ستستضيف السعودية أسبوع الرياض للموضة من 20 إلى 23 أكتوبر مع مجموعة من 30 علامة محلية معروضة على منصة العرض.",
    button: "Read Full Article",
  ...
  {
    title:
      "Riyadh Fashion Week: 30 KSA Brands To Show At Saudi Arabia's First Fashion Week",
    title_ar: "أسبوع الرياض للموضة: 30 علامة سعودية ستعرض في أول أسبوع موضة في السعودية",
    description:
      "Hosted by the Saudi Fashion Commission, the upcoming event will feature a lineup of 30 brands from the Kingdom.",
    description_ar: "تستضيفه هيئة الأزياء السعودية، سيضم الحدث القادم مجموعة من 30 علامة من المملكة.",
    button: "Read Full Article",
    image: require("../../images/pressimages/BAZAAR (1).webp"),
  ...
  {
    title:
      "Riyadh Fashion Week: Everything You Need to Know About the First Edition",
    title_ar: "أسبوع الرياض للموضة: كل ما تحتاج معرفته عن النسخة الأولى",
    description:
    ...
    description_ar: "أسبوع الرياض للموضة الافتتاحي في السعودية مقرر رسمياً للظهور من 20-23 أكتوبر. مجموعة مذهلة من 30 علامة سعودية ستحتفي على منصة العرض، مصحوبة بحشد من المشاهير العالميين وكبار الشخصيات والمشترين وأصحاب المصلحة الرئيسيين في الصناعة مستعدين للاستيلاء على العاصمة احتفالاً بمشهد الموضة السعودي الناشئ بسرعة.",
    button: "Read Full Article",
  ...
  {
    title:
      "Saudi Arabia's Riyadh Fashion Week to Make its Debut with 30 Local Brands",
    title_ar: "أسبوع الرياض للموضة في السعودية يقدم أول ظهوره مع 30 علامة محلية",
    description:
    ...
    description_ar: "من 20-23 أكتوبر، ستكون السعودية مليئة بالحيوية مع النسخة الافتتاحية من أسبوع الرياض للموضة، مع عرض مجموعة مذهلة من 30 علامة محلية على منصة العرض.",
    button: "Read Full Article",
  ...
  },
  {
    ...
    title_ar: "أول أسبوع موضة في السعودية يعرض 30 علامة",
    description:
    ...
    description_ar: 'ثلاثون علامة سعودية ستحكم منصة العرض في "أسبوع الرياض للموضة" الافتتاحي الذي سيقام في العاصمة من 20-23 أكتوبر.',
    button: "Read Full Article",
  ...
  {
    title:
      "Saudi Arabia's first fashion week set to dazzle with 30 Saudi brands' lineup",
    title_ar: "أول أسبوع موضة في السعودية مستعد للإبهار مع مجموعة من 30 علامة سعودية",
    description:
    ...
    description_ar: 'سيضيء تدشين أول "أسبوع موضة في الرياض" قلب عاصمة السعودية من 20-23 أكتوبر مع مجموعة من 30 علامة سعودية تستولي على منصة العرض.',
    button: "Read Full Article",
    image: require("../../images/pressimages/SaudiGazette2.webp"),
  ...
  },
  {
    ...
    description_ar: "سيجمع مجتمع الموضة العالمي، بما في ذلك المشاهير وكبار الشخصيات والمشترون وأصحاب المصلحة الرئيسيون في الصناعة للاحتفال بمشهد الموضة السعودي الناشئ بسرعة",
    button: "Read Full Article",
    image: require("../../images/pressimages/zaywa.webp"),
  ...
  {
    title:
      "Saudi Fashion Commission announces plans for October Fashion Week in Riyadh",
    title_ar: "هيئة الأزياء السعودية تعلن عن خطط لأسبوع الموضة في أكتوبر بالرياض",
    description:
      "The Saudi Fashion Commission has announced plans to debut its first Fashion Week in Riyadh,to be staged from October 20 to 23.",
    description_ar: "أعلنت هيئة الأزياء السعودية عن خطط لإطلاق أول أسبوع موضة لها في الرياض، المقرر إقامته من 20 إلى 23 أكتوبر.",
    button: "Read Full Article",
    image: require("../../images/pressimages/FashionNetwork.webp"),
  ...
  },
  {
    ...
    title_ar: "أول أسبوع موضة في السعودية سيقام هذا أكتوبر",
    description:
      "Mark your calendars! Saudi Arabia's first fashion week has been scheduled to take place in Riyadh this Autumn.",
    description_ar: "ضع علامة في التقويم! تم جدولة أول أسبوع موضة في السعودية ليقام في الرياض هذا الخريف.",
    button: "Read Full Article",
  ...
  {
    title:
      "AT PARIS FASHION WEEK, THE SAUDI FASHION COMMISSION ANNOUNCES THE FIRST FASHION WEEK IN SAUDI ",
    title_ar: "في أسبوع باريس للموضة، هيئة الأزياء السعودية تعلن عن أول أسبوع موضة في السعودية",
    description:
    ...
    description_ar: "ضع علامة في التقويم لأول أسبوع موضة في السعودية. تستضيفه هيئة الأزياء السعودية، الحدث الافتتاحي مقرر إقامته بين 20 و 23 أكتوبر القادم.",
    button: "Read Full Article",
  ...
  },
  {
    ...
    title_ar: "هيئة الأزياء السعودية تعلن عن خطط أسبوع الموضة",
    description:
      "The Saudi Fashion Commission has announced its plans to launch the nation's inaugural fashion week, set to take place in Riyadh.",
    description_ar: "أعلنت هيئة الأزياء السعودية عن خططها لإطلاق أول أسبوع موضة للبلاد، المقرر إقامته في الرياض.",
    button: "Read Full Article",
  ...
  },
  {
    ...
    title_ar: "السعودية تعلن عن أول أسبوع موضة",
    description:
      "As emerging Saudi brands continue to make their mark on the international Fashion Weeks, the Kingdom is set to get one of its own, announcing a first ever Saudi Fashion Week.",
    description_ar: "بينما تستمر العلامات السعودية الناشئة في ترك بصمتها على أسابيع الموضة الدولية، المملكة تستعد للحصول على واحد خاص بها، معلنة عن أول أسبوع موضة سعودي.",
    button: "Read Full Article",
    image: require("../../images/pressimages/ESQUIRE.webp"),
  ...
  },
  {
    ...
    title_ar: "كل ما تحتاج معرفته عن أسبوع الموضة السعودي",
    description:
    ...
    description_ar: "أعلنت هيئة الأزياء السعودية أن أسبوع الموضة السعودي سيقام من 20 إلى 23 أكتوبر 2023 في عاصمة البلاد، الرياض.",
    button: "Read Full Article",
  ...
  },
  {
    ...
    title_ar: "السعودية تستضيف أول أسبوع موضة في أكتوبر",
    description:
      "The first-ever Saudi Arabian fashion week will take place in the capital, Riyadh this October.  ",
    description_ar: "أول أسبوع موضة سعودي سيقام في العاصمة، الرياض هذا أكتوبر.",
    button: "Read Full Article",
  ...
  {
    title:
      "Saudi Arabia announces plans to host its first official fashion week ",
    title_ar: "السعودية تعلن عن خطط لاستضافة أول أسبوع موضة رسمي",
    description:
    ...
    description_ar: "إذا كنت تنتظر بصبر أن تقدم السعودية نسختها الخاصة من أسبوع الموضة، فأنت محظوظ حيث تم الإعلان عن خطط لأسبوع الموضة السعودي.",
    button: "Read Full Article",
    image: require("../../images/pressimages/whatson.webp"),
